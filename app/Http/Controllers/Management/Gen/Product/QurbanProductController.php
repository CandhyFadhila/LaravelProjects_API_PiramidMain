...
class QurbanProductController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            Log::channel('gen_qurban_product')->error('| Index | - Error function index : ' . $e->getMessage());
            return response()->json(
                new WithoutDataResource(
    ...
    public function store(StoreQurbanProduct $request)
    {
        try {
            ...
            DB::rollBack();
            Log::channel('gen_qurban_product')->error('| Store | - Error function store : ' . $e->getMessage());
            return response()->json(
                new WithoutDataResource(
                    Response::HTTP_INTERNAL_SERVER_ERROR,
                    'ERROR_GET_DATA',
    ...
    public function show($id)
    {
        try {
            ...
            Log::channel('gen_qurban_product')->error('| Detail | - Error function show : ' . $e->getMessage());
            return response()->json(
                new WithoutDataResource(
                    Response::HTTP_INTERNAL_SERVER_ERROR,
                    'ERROR_GET_DATA',
    ...
    public function update(UpdateQurbanProduct $request, $id)
    {
        try {
            ...
            DB::rollBack();
            Log::channel('gen_qurban_product')->error('| Update | - Error function update : ' . $e->getMessage());
            return response()->json(
                new WithoutDataResource(
                    Response::HTTP_INTERNAL_SERVER_ERROR,
                    'ERROR_GET_DATA',
    ...
    public function destroy($id)
    {
        try {
            ...
            DB::rollBack();
            Log::channel('gen_qurban_product')->error('| Destroy | - Error function destroy : ' . $e->getMessage());
            return response()->json(
                new WithoutDataResource(
                    Response::HTTP_INTERNAL_SERVER_ERROR,
                    'ERROR_GET_DATA',
    ...
    public function restore($id)
    {
        try {
            ...
            DB::rollBack();
            Log::channel('gen_qurban_product')->error('| Restore | - Error function restore : ' . $e->getMessage());
            return response()->json(
                new WithoutDataResource(
                    Response::HTTP_INTERNAL_SERVER_ERROR,
                    'ERROR_GET_DATA',
